...
from peterest.models import Usuario

class FormLogin(FlaskForm):
    email = StringField("e-mail", validators=[DataRequired(), Email()])
    senha = PasswordField("senha", validators=[DataRequired()])
    botao_comfirmation = SubmitField("fazer login")
...
class FormCriarConta(FlaskForm):
    ...
    comfirmar_senha = PasswordField("Confirmar Senha", validators=[DataRequired(), EqualTo("senha")])
